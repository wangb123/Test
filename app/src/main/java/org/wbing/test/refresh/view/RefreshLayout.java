package org.wbing.test.refresh.view;
...
public class RefreshLayout extends FrameLayout {
    ...
    private void getAttrs() {
        ...
        mRingTop = (int) typedArray.getDimension(R.styleable.HaloRingRefreshLayout_ringTop, 50);
        mRingColor = typedArray.getColor(R.styleable.HaloRingRefreshLayout_ringColor, 0xFF828EFA);
        mHeaderHeight = typedArray.getDimension(R.styleable.HaloRingRefreshLayout_headerHeight, 200);
    ...
    public interface OnRefreshListener{
        void onRefresh(RefreshLayout parent);
    }
}
