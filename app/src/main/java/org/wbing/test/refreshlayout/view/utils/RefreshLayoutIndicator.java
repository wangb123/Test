package org.wbing.test.refreshlayout.view.utils;
...
/**
 * Created by suitian on 16/9/5.
 */

public class RefreshLayoutIndicator {
    public final static int POS_START = 0;
    protected int mOffsetToRefresh = RefreshLayout.HEAD_HEIGHT;
    ...
    public void convertFrom(RefreshLayoutIndicator ptrSlider) {
    ...
    public float getPtLastMoveX() {
        return mPtLastMove.x;
    }

    public float getPtLastMoveY() {
        return mPtLastMove.y;
    }
}
