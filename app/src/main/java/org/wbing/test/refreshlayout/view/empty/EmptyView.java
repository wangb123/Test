package org.wbing.test.refreshlayout.view.empty;
...
public class EmptyView extends LinearLayout {
    ...
    private int mEmptyIcon = R.mipmap.icon_empty_net_error;
    private int mErrorIcon = R.mipmap.icon_empty_net_error;
    /**
     * 空view的文案
     */
    ...
    public void showEmptyDefault() {
        ...
        setEmptyIcon(R.mipmap.icon_empty_net_error);
    ...
    public void showErrorDefault() {
        ...
        setErrorIcon(R.mipmap.icon_empty_net_error);
