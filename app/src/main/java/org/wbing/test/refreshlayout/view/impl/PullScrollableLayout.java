package org.wbing.test.refreshlayout.view.impl;
...
import org.wbing.test.refreshlayout.view.scrollablelayout.ScrollableLayout;
import org.wbing.test.refreshlayout.view.wrapper.EmptyRefreshLayout;
...
public class PullScrollableLayout extends EmptyRefreshLayout {
    ...
    protected boolean childIsOnTop() {
        ...
        result = contentView.getCurrentY() > 0;
        return !result;
    }
